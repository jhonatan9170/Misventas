                            ...
                            return Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Column(
                                    children: [
                                      Text("Apellidos ",style: TextStyle(fontSize: 18.0,fontWeight: FontWeight.bold),),
                                      Text(client.apePaterno+" "+client.apeMaterno,style: TextStyle(fontSize: 18.0,),),
                                      Text("Nombres ",style: TextStyle(fontSize: 18.0,fontWeight: FontWeight.bold),),
                                      Text(client.nombres,style: TextStyle(fontSize: 18.0,),),
                                      Text("DNI ",style: TextStyle(fontSize: 18.0,fontWeight: FontWeight.bold),),
                                      Text(client.dni.toString(),style: TextStyle(fontSize: 18.0,),),
                                    ],
                                  ):
                                  Column(
                                    children: [
                                      Text("Razon Social ",style: TextStyle(fontSize: 18.0,fontWeight: FontWeight.bold),),
                                      Text(client.razonSocial,style: TextStyle(fontSize: 18.0,),),
                                      Text("Nombre Comercial ",style: TextStyle(fontSize: 18.0,fontWeight: FontWeight.bold),),
                                      Text(client.nombreComercial,style: TextStyle(fontSize: 18.0,),),
                                    ],
                                  ),
                                  Column(
                                    children: [
                                      Text("Telefono fijo ",style: TextStyle(fontSize: 18.0,fontWeight: FontWeight.bold),),
                                      Text(client.telfijo.toString(),style: TextStyle(fontSize: 18.0,),),
                                      Text("Celular ",style: TextStyle(fontSize: 18.0,fontWeight: FontWeight.bold),),
                                      Text(client.celular.toString(),style: TextStyle(fontSize: 18.0,),),
                                    ],
                                  ),
                                  client.estado=='A'?
                                  Column(
